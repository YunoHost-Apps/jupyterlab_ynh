...
#  available.
#  Default: True
c.ServerApp.terminals_enabled = bool(__ENABLE_TERMINAL__)
...
#  Choices: any of ['md5', 'sha3_224', 'sha3_256', 'blake2s', 'sha224', 'sha512', 'blake2b', 'sha1', 'sha3_384', 'sha384', 'sha3_512', 'sha256']
#  Default: 'sha256'
